					...
					controls: [
						...
						},
						{
							...
							controls: [
								{
									type: DefaultControls.CheckBox,
									name: "designAnalysisCoefficients"
								}
							]
						}
					]
